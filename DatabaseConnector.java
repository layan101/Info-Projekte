 ...
 * </p>
 * <p>
 * Klasse com.company.DatabaseConnector
 * </p>
 * <p>
 * Ein Objekt der Klasse com.company.DatabaseConnector ermoeglicht die Abfrage und Manipulation
...
public class DatabaseConnector{
  ...
  /**
   * Ein Objekt vom Typ com.company.DatabaseConnector wird erstellt, und eine Verbindung zur Datenbank
  ...
  public void executeStatement(String pSQLStatement){  
    ...
    try {
      ...
      if (statement.execute(pSQLStatement)) { //Fall 1: Es gibt ein Ergebnis
        ...
        //com.company.Queue fuer die Zeilen der Ergebnistabelle erstellen
        Queue<String[]> rows = new Queue<String[]>();

        //Daten in com.company.Queue uebertragen und Zeilen zaehlen
        int rowCount = 0;
        ...
        //Ergebnisfeld erstellen und Zeilen aus com.company.Queue uebertragen
   ...
   * die Datenbank geschickten SQL-Befehls als Ob-jekt vom Typ com.company.QueryResult zurueck.
